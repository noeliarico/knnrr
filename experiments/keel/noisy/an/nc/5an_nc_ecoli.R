ecoli_5an_nc_5_1tra <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-1tra.dat")
ecoli_5an_nc_5_1tst <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-1tst.dat")
ecoli_5an_nc_5_1tst$Site <- factor(as.character(ecoli_5an_nc_5_1tst$Site), levels = c("cp","im","imL","imS","imU","om","omL","pp"))
ecoli_5an_nc_5_2tra <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-2tra.dat")
ecoli_5an_nc_5_2tst <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-2tst.dat")
ecoli_5an_nc_5_2tst$Site <- factor(as.character(ecoli_5an_nc_5_2tst$Site), levels = c("cp","im","imL","imS","imU","om","omL","pp"))
ecoli_5an_nc_5_3tra <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-3tra.dat")
ecoli_5an_nc_5_3tst <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-3tst.dat")
ecoli_5an_nc_5_3tst$Site <- factor(as.character(ecoli_5an_nc_5_3tst$Site), levels = c("cp","im","imL","imS","imU","om","omL","pp"))
ecoli_5an_nc_5_4tra <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-4tra.dat")
ecoli_5an_nc_5_4tst <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-4tst.dat")
ecoli_5an_nc_5_4tst$Site <- factor(as.character(ecoli_5an_nc_5_4tst$Site), levels = c("cp","im","imL","imS","imU","om","omL","pp"))
ecoli_5an_nc_5_5tra <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-5tra.dat")
ecoli_5an_nc_5_5tst <- read.keel("data/keel/noisy/an/nc/nc5/ecoli-5an-nc/ecoli-5an-nc-5-5tst.dat")
...
class_index <- 8
ecoli_5an_nc_5_1 <- noelia_train(ecoli_5an_nc_5_1tra, ecoli_5an_nc_5_1tst, class_index)
ecoli_5an_nc_5_2 <- noelia_train(ecoli_5an_nc_5_2tra, ecoli_5an_nc_5_2tst, class_index)
ecoli_5an_nc_5_3 <- noelia_train(ecoli_5an_nc_5_3tra, ecoli_5an_nc_5_3tst, class_index)
ecoli_5an_nc_5_4 <- noelia_train(ecoli_5an_nc_5_4tra, ecoli_5an_nc_5_4tst, class_index)
ecoli_5an_nc_5_5 <- noelia_train(ecoli_5an_nc_5_5tra, ecoli_5an_nc_5_5tst, class_index)
...
# compare_metric_noisy("ecoli_5an_nc", metric = "Kappa", input = "numerical")
# compare_metric_noisy("ecoli_5an_nc", metric = "F1", input = "numerical")
