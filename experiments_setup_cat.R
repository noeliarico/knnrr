# La misma porque multiclasssummary automaticamente detecta si es binario
# o multiclase para hacer los cálculos de las métricas Mean_
# Puesto en dos diferentes para que sea parametrizable
